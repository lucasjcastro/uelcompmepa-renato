...
bool Sintatico::programa(){
    ...
    if(!strcmp(a.token,"program")){
        raiz->setNome("programa principal");
        raiz->setTipo("programa principal");
        raiz->setHash(&hash);
        fila.pop();
        a = fila.front();
        if(!strcmp(a.classificacao,"identificador")){
            ...
            if(!strcmp(a.token,";")){
                fila.pop();
                if(!bloco(raiz))return false;
                a = fila.front();
                if(!strcmp(a.token,".")){ raiz->imprimeNo(); return true;}
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::bloco(No_Arvore * no1){
    ...
    if(!strcmp(a.token,"var")){
        ...
        while(!strcmp(a.token,"procedure") || !strcmp(a.token,"function")){
            if(!strcmp(a.token,"procedure")){
                fila.pop();
                if(!bloco_procedure(no1)) return false;
                a = fila.front();
            }
            else if(!strcmp(a.token,"function")){
                fila.pop();
                if(!bloco_function(no1)) return false;
                a = fila.front();
            }
        }
    }
    ...
    if(!strcmp(a.token,"begin")){
        fila.pop();
        if(!bloco_begin(no1)) return false;
        return true;
    }
...
Retorno: true - se não houver erros
         false - se houver erros
*/
bool Sintatico::bloco_procedure(No_Arvore * no1){
...
Retorno: true - se não houver erros
         false - se houver erros
*/
bool Sintatico::bloco_function(No_Arvore * no1){
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::bloco_begin(No_Arvore * no1){
    
    No_Comando * noC;
    
    noC = new No_Comando();
    if(!comando(noC)) return false;
    no1->addComando(noC);
    a = fila.front();
    while(!strcmp(a.token,";")){
        fila.pop();
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando(No_Comando * no1){
    ...
    if(!strcmp(a.classificacao,"identificador")){
        ...
        if(!strcmp(a.token,":=")){
            fila.pop();
            if(!comando_atrib(no1)) return false;
        }
        else if(!strcmp(a.token,"(")){
            fila.pop();
            if(!comando_id(no1)) return false;
        }
        return true;
    }
    else if(!strcmp(a.token,"begin")){
        fila.pop();        
        if(!comando_begin(no1)) return false;
        return true;
    }
    else if(!strcmp(a.token,"if")){
        fila.pop();
        if(!comando_if(no1)) return false;
        return true;
    }
    else if(!strcmp(a.token,"while")){
        fila.pop();
        if(!comando_while(no1)) return false;
        return true;
    }
    else if(!strcmp(a.token,"read")){
        fila.pop();
        if(!comando_read(no1)) return false;
        return true;
    }
    else if(!strcmp(a.token,"write")){
        fila.pop();
        if(!comando_write(no1)) return false;
        return true;
    }
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando_atrib(No_Comando * no1){
    no1->setTipo("atribuicao");
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando_id(No_Comando * no1){
    
    
    no1->setTipo("chamada funcao");
    if(!expressao()) return false;
    a = fila.front();
    while(!strcmp(a.token,",")){
        fila.pop();
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando_begin(No_Comando * no1){
    
    No_Comando * no2;
    
    no1->setTipo("comando bloco");

    no2 = new No_Comando();
    if(!comando(no2)) return false;
    no1->setComandoFilho(no2);
    a = fila.front();
    while(!strcmp(a.token,";")){
        fila.pop();
        if(!comando(no2)) return false;
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando_if(No_Comando * no1){
...
Retorno: true - se não houver erros
         false - se houver erros
*/
bool Sintatico::comando_while(No_Comando * no1){
...
Retorno: true - se não houver erros no bloco de comandos
         false - se houver erros
*/
bool Sintatico::comando_read(No_Comando * no1){
...
Retorno: true - se não houver erros 
         false - se houver erros
*/
bool Sintatico::comando_write(No_Comando * no1){
